...
export default function AcerteNumero() {
    return (
        <div className='appJs'>
            <h4 className='titulo-hg'>Jogo Acerte o Número</h4>
            <div className='container-hg d-flex justify-content-center align-items-center'>
                ...
                <div className='descricao-hg'>
                    ...
                    <h6>Como acessar?</h6>
                    <p><strong>Acesse o Projeto: </strong>Para explorar e experimentar, visite o seguinte link:  <a className='navegação-hl' href='https://numero-secreto-kohl.vercel.app/' target='blank'>Jogo Acerte o Número - Acesse aqui!</a>  (Recomenda-se utilizar o Google Chrome)</p>
                </div>
