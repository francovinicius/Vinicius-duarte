        ...
        <div>
            ...
            <div className='container-hg d-flex justify-content-center align-items-center'>
                ...
                <div className='descricao-hg'>
                    ...
                    <p>O cartão de visita conta com uma breve descrição da solicitante, permitindo aos visitantes obterem uma visão geral dos serviços ou produtos oferecidos. Além disso, são disponibilizados links clicáveis que direcionam para os principais meios de contato, como website, redes sociais e outras plataformas relevantes.</p>
                    ...
                    <p>Adicionalmente, o cartão de visita interativo inclui uma seção de contatos, onde os visitantes podem entrar em contato diretamente com a equipe da solicitante por meio de um formulário de envio de e-mail. Essa funcionalidade é implementada utilizando uma API, garantindo um processo de envio seguro e confiável.</p>
                    <p>O projeto utiliza o poderoso framework React.js para garantir uma experiência de usuário fluida e interativa. A integração de tecnologias modernas e o design atraente tornam o cartão de visita uma ferramenta eficiente para promover a solicitante e facilitar o contato direto com a equipe.</p>
                    <p>Com o cartão de visita interativo, a solicitante possui uma presença digital impactante e personalizada, permitindo que os visitantes encontrem facilmente as informações necessárias e estabeleçam uma comunicação direta e eficiente com a equipe.</p>
                </div>
            </div>
