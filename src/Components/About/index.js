    ...
    return (
        <section className='appJs'>
            ...
            <div className="d-flex flex-column align-items-center justify-content-center pt-br">
                ...
                <p className='p-about'>Atualmente trabalho como desenvolvedor, onde sou responsável pelo desenvolvimento e manutenção de uma plataforma de intranet para comunicação interna e compartilhamento de informações, gerenciamento de algumas aplicações web, implemetação de um novo sistema de integração de colaboradores, criação de aplicativos entre outras funcionalidades. Também possuo uma posição mais analítca, onde sou responsável pela criação dos POPs (Procedimentos Operacionais Padrões), supervisiono a equipe relacionada ao controle de relógios e pontos, criando relatórios analíticos para a folha de pagamento e mantendo bancos de dados seguros e eficientes. </p>
