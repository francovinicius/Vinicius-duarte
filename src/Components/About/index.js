    ...
    return (
        <section className='appJs'>
            ...
            <div className="d-flex flex-column align-items-center justify-content-center pt-br">
                <p className='p-about'>Olá mundo! Eu sou Vinicius Franco Duarte, Desenvolvedor, posso desenvolver sites responsivos a partir do zero e transformá-los em experiências web modernas e fáceis de usar.</p>
                ...
                <p className='p-about'>Estou sempre bem animado em conhecer pessoas novas, novos ensinamentos e novas culturas! Caso queira saber mais, entre em contato comigo através da seção contatos. Um grande abraço!</p>
            </div>
